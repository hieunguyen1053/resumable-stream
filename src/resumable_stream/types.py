...
class Subscriber(ABC):
    ...
    @abstractmethod
    def subscribe(self, channel: str, callback: Callable[[str], Any]) -> Awaitable[Union[None, int]]:
        ...
...
class RedisDefaults:
    ...
    """
    def __init__(self, subscriber: Callable[[], Subscriber], publisher: Callable[[], Publisher]):
